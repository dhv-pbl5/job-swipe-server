...
public class ChatController {
    ...
    public ResponseEntity<ApiDataResponse> getConversations(
        ...
        if (conversationId != null)
            return ResponseEntity
                    .ok(ApiDataResponse.successWithoutMeta(service.getConversationById(account, conversationId)));
    ...
    public ResponseEntity<ApiDataResponse> getUnreadMessageCount(
            ...
            @CurrentAccount Account account) {
        return ResponseEntity
                .ok(ApiDataResponse.successWithoutMeta(service.getUnreadMessageCount(account, conversationId)));
    }
    ...
    public ResponseEntity<ApiDataResponse> getMessages(
        ...
        if (messageId != null)
            return ResponseEntity
                    .ok(ApiDataResponse.successWithoutMeta(service.getMessageById(account, conversationId, messageId)));
    ...
    public ResponseEntity<ApiDataResponse> sendMessage(
        ...
        return ResponseEntity
                .ok(ApiDataResponse.successWithoutMeta(service.sendMessage(account, conversationId, files, content)));
    }
